...
原文地址：https://www.liaoxuefeng.com/wiki/0014316089557264a6b348958f449949df42a6d3a2e542c000/001432712108300322c61f256c74803b43bfd65c6f8d0d0000#0
...
## 补充
若Python2与Python3都安装了virtualenv，那么在创建Python运行环境的时候，需要指定Python的执行文件

```bash
$ virtualenv -p /usr/local/bin/python3.5 --no-site-packages venv3
```
